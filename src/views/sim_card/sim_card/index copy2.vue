  ...
  <div class="app-container calendar-list-container" id="basicData_search_index">
    <div class="filter-container search">
      <el-row class="filter-item" >
        <el-col :span="4">
          <el-input :placeholder="$t('simcard.cpIP')" v-model="listQuery.q.cpIP" clearable type="text"> </el-input>
        </el-col>
        <el-col :span="4">
          <el-input :placeholder="$t('simcard.imsi')" v-model="listQuery.q.imsi" clearable type="text"> </el-input>
        </el-col>
        <el-col :span="4">
          <el-input :placeholder="$t('simcard.iccid')" v-model="listQuery.q.iccid" clearable type="text"> </el-input>
        </el-col>
        <el-col :span="4">
      ...
      <el-row >
        ...
        <el-col :span="20">
          ...
          <el-button  type="primary" icon="search" @click="resetFilter">重置</el-button>
