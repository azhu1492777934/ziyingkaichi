<template>
  <div class="app-container calendar-list-container" id="basicData_search_index">
    <div class="filter-container search">
      <el-row>
        ...
        <el-col :span="12">
          ...
          <a :href="'#/operation/used_net/new'" target="_self" style="margin-left: 10px;">
    ...
    <el-table
      ...
      <el-table-column
        prop="countryCn"
        v-bind:label="$t('used_net.countryCn')"
        width="150">
      </el-table-column>
      ...
      >
        <template slot-scope="scope">
          <a :href="'#/operation/used_net/edit/' + scope.row.id" target="_self"><el-button size="small" type="primary" plain>编辑</el-button></a>
