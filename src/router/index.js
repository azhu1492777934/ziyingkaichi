...
export const constantRouterMap = [
...

  {
    ...
    children: [
      ...
      // { path: 'terminal_info', component: () => import('@/views/terminal/terminal_info/index'), name: '设备信息统计' },
...

  {
    ...
    children: [
      ...
      // { path: 'simcard_info', component: () => import('@/views/sim_card/simcard_info/index'), name: '卡概要信息' },
